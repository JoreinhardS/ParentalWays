...
export function ArticleCard({ title, imageUrl, className, tag, style }) {
  return (
    ...
    >
      ...
      <div className="absolute -bottom-1 z-10 flex h-[2.0156rem] w-full items-center bg-black/[0.17] pl-[.59rem] pr-[.3444rem] backdrop-blur-[6.9px] sm:h-[2.8631rem] sm:pl-[.8319rem] sm:pr-[.4888rem] xl:h-[5.125rem] xl:pl-6 xl:pr-[.875rem]">
        <h3
          style={style}
