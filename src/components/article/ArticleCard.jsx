...
export function ArticleCard({ title, imageUrl, className, tag, style }) {
  return (
    <div
      className={cn(
        'w-[9.44rem] h-[8.6781rem] sm:w-[13.4063rem] sm:h-[12.415rem] xl:w-[24rem] xl:h-[22.0625rem] relative',
        className
      )}
    >
      <img src={imageUrl} alt={title} className="h-full w-full object-cover" />
      <span className="bg-primary-10 absolute right-[5.99px] top-[6.92px] z-10 flex h-[.7681rem] w-[1.9856rem] items-center justify-center rounded-full p-[3px] text-[.3444rem] font-normal text-white sm:right-[8.69px] sm:top-[14.94px] sm:h-[17.94px] sm:w-[44.94px] sm:p-[4.47px] sm:text-[7.82px] xl:right-6 xl:top-6 xl:h-[33px] xl:w-20 xl:p-2 xl:text-[.875rem]">
        {tag}
      </span>
