...
export function ArticleReplyInput() {
  return (
    <FormGroup className="relative mt-[.6875rem] md:mt-[2.8125rem] xl:mt-9">
      <InputTextarea
        className="h-[8.375rem] w-full resize-none rounded bg-primary-90 pl-[1.2588rem] pt-[.7925rem] text-[.75rem] italic text-black placeholder:text-black md:h-[12.625rem] md:pl-6 md:pt-6 md:text-lg xl:h-[14.125rem] xl:pl-[4.375rem] xl:pt-[2.8125rem]"
